...
const app = new kubernetes.apps.v1.Deployment("find-the-sun-deployment", {
    spec: {
                ...
                containers: [
                    {
                        ...
                        image: "sesgoe/python-find-the-sun",
                        env: [
                            {
...
const appService = new kubernetes.core.v1.Service("find-the-sun-service", {
    spec: {
        type: "LoadBalancer",
